...
import {
    ...
    Buttonex,
    WelcomeLogo, 
    MainNavBarContainer} from '../../StyledComponents/index';
import {ReactComponent as HomeIcon} from '../../assets/svg/3010995.svg';
import {ReactComponent as GalleryIcon} from '../../assets/svg/1829500.svg';
import {ReactComponent as ContactIcon} from '../../assets/svg/4542044.svg';
    ...
    return (
        ...
        <MainNavBarContainer>
            ...
            <WelcomeLogo>
                ...
                <span className="brand-title">Y me puse a tejer</span>
                </WelcomeLogo>
